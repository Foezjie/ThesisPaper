...
Databases en webserver zijn abstracties die bestaan uit een verzameling basisobjecten zoals bestanden, pakketten en services.\todo{Beter woord voor abstracties}
...
De andere aanpak tijdens het uitrollen van een model laat toe afhankelijkheden tussen hoog-niveau objecten te specifi\"eren:
...
%Aangezien deze relaties gespecifi\"eerd zijn tussen concepten, en concepten op verschillende machines kunnen uitgerold worden, kan IMP afhankelijkheden over verschillende machines verwerken.
